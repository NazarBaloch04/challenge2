...
// favoriteTransportation.push(["car", "rolsroie"]);
// favoriteTransportation.push(["bycycle", "sohrab"]);
...
// let guestList = ['Shahid', 'Noman',  'Siraj'];
...
// console.log(guestList);
// for (let guest of guestList){
// console.log(`Assalam o Alaikum ${guest}, we had just found a bigger dinner Table`)
// }
...
// // • Use append() to add one new guest to the end of your list.
// // • Print a new set of invitation messages, one for each person in your list.
// let guestList = ['Shahid', 'Noman', 'Parvaiz', 'SanaUllah'];
...
// let message = `numberOfDinnerGuests ${numberOfDinnerGuests}`;
...
// let person = { name: "Nazar Baloch", fname: "male", age: 18, education: "intermidiate" };
// console.log(person);
...
// const magiciansnames = ['Doug Henning (Canadian) (1947-2000)', 'Siegfried & Roy (German / American)', ' Max Maven (American) (1950-2022)', 'Eugene Burger (American) (1939-2017)', 'David Copperfield (American) (born 1956)'];
